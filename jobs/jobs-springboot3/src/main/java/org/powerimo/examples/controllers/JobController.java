...
public class JobController {
    ...
    public List<StepDescriptor> getStepDescriptors(@PathVariable(name = "code") String code) {
        return jobService.getDescriptorRepository().getStepDescriptors(code);
    }

    @PostMapping("{code}/run")
    public JobStateDto postJobRun(@PathVariable(name = "code") String code,
                                  @RequestBody HashMap<String, String> params) throws NoSuchMethodException {
